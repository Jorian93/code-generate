package cn.jorian.handle.async;

import cn.jorian.handle.AutoMaticApp;
import cn.jorian.handle.annotation.PrimaryKey;
import cn.jorian.handle.annotation.TableName;
import cn.jorian.handle.configure.PackageNameConfigure;
import cn.jorian.handle.configure.VarTypeConfigure;
import cn.jorian.handle.configure.ClassNameConfigure;
import cn.jorian.handle.configure.MethodNameConfigure;
import cn.jorian.handle.utils.CodeMatcher;
import java.io.*;
